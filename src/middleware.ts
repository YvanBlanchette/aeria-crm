...
// Protège toutes les pages de l'application sauf /login.
...
export function middleware(request: NextRequest) {
	...
	const isAuthRoute = request.nextUrl.pathname.startsWith("/login") || request.nextUrl.pathname.startsWith("/signin");
