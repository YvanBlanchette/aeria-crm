  ...
  initSqlJsPromise = new Promise(function (resolveModule, reject) {
    ...
    e.onRuntimeInitialized = function () {
      ...
      var h = B(4),
        ...
        w = k("sqlite3_exec", "number", ["number", "string", "number", "number", "number"]),
        A = k("sqlite3_changes", "number", ["number"]),
        S = k("sqlite3_prepare_v2", "number", ["number", "string", "number", "number", "number"]),
        nb = k("sqlite3_sql", "string", ["number"]),
        qc = k("sqlite3_normalized_sql", "string", ["number"]),
        ...
        vc = k("sqlite3_step", "number", ["number"]),
        wc = k("sqlite3_errmsg", "string", ["number"]),
        xc = k("sqlite3_column_count", "number", ["number"]),
        yc = k("sqlite3_data_count", "number", ["number"]),
        zc = k("sqlite3_column_double", "number", ["number", "number"]),
        qb = k("sqlite3_column_text", "string", ["number", "number"]),
        Ac = k("sqlite3_column_blob", "number", ["number", "number"]),
        Bc = k("sqlite3_column_bytes", "number", ["number", "number"]),
        Cc = k("sqlite3_column_type", "number", ["number", "number"]),
        Dc = k("sqlite3_column_name", "string", ["number", "number"]),
        Ec = k("sqlite3_reset", "number", ["number"]),
        Fc = k("sqlite3_clear_bindings", "number", ["number"]),
        Gc = k("sqlite3_finalize", "number", ["number"]),
        rb = k(
          "sqlite3_create_function_v2",
          "number",
          "number string number number number number number number number".split(" "),
        ),
        kc = k("sqlite3_value_type", "number", ["number"]),
        nc = k("sqlite3_value_bytes", "number", ["number"]),
        mc = k("sqlite3_value_text", "string", ["number"]),
        oc = k("sqlite3_value_blob", "number", ["number"]),
        lc = k("sqlite3_value_double", "number", ["number"]),
        hc = k("sqlite3_result_double", "", ["number", "number"]),
        ...
        sb = k("sqlite3_aggregate_context", "number", ["number", "number"]),
          ...
          for (g = []; 0 !== l(G, "i8");) {
            ...
            if (0 !== I) {
              ...
              for (null != m && v.bind(m); v.step();)
                (null === y && ((y = { columns: v.getColumnNames(), values: [] }), g.push(y)),
                  y.values.push(v.get(null, n)));
              v.free();
            }
          }
          return g;
      ...
      f.prototype.close = function () {
        null !== this.db &&
          (Object.values(this.Za).forEach(function (g) {
            g.free();
          }),
          Object.values(this.Na).forEach(ra),
          (this.Na = {}),
    ...
    var va = Object.assign({}, e),
      ...
      Fa;
    if (Aa)
      ((D = za ? require("path").dirname(D) + "/" : __dirname + "/"),
        (Fa = () => {
    ...
    var Ga = e.print || console.log.bind(console),
      Ha = e.printErr || console.warn.bind(console);
    Object.assign(e, va);
    va = null;
      ...
      switch (b) {
        ...
        case "i64":
          O = [
            ...
            1 <= +Math.abs(N)
              ? 0 < N
                ? (Math.min(+Math.floor(N / 4294967296), 4294967295) | 0) >>> 0
                : ~~+Math.ceil((N - +(~~N >>> 0)) / 4294967296) >>> 0
              : 0),
          ];
          F[a >> 2] = O[0];
          F[(a + 4) >> 2] = O[1];
    ...
    var mb = {
      ...
      Q = {
        ...
        createNode: function (a, b, c, d) {
          ...
          Q.Qa ||
            (Q.Qa = {
              ...
              pb: { node: { Pa: Q.Ga.Pa, Oa: Q.Ga.Oa }, stream: vb },
            });
          c = wb(a, b, c, d);
          16384 === (c.mode & 61440)
            ...
            : 32768 === (c.mode & 61440)
              ...
              : 40960 === (c.mode & 61440)
                ...
                : 8192 === (c.mode & 61440) && ((c.Ga = Q.Qa.pb.node), (c.Ha = Q.Qa.pb.stream));
        ...
        qb: function (a, b) {
          ...
          c >= b ||
            ...
            0 < a.Ma && a.Ia.set(c.subarray(0, a.Ma), 0));
        },
        Gb: function (a, b) {
          if (a.Ma != b)
        ...
        Ha: {
          ...
          Ta: function (a, b, c) {
            1 === c
              ? (b += a.position)
              : 2 === c && 32768 === (a.node.mode & 61440) && (b += a.node.Ma);
      ...
      V = (a, b) => ha(a, ((void 0 !== b ? b : 511) & 1023) | 16384, 0),
      Rb = (a, b, c) => {
      ...
      ja = (a, b, c) => {
        ...
        if (
          ...
          (c = f
            ? 40960 === (f.mode & 61440)
              ? 32
              : 16384 === (f.mode & 61440) && ("r" !== Kb(b) || b & 512)
                ? 31
                : Hb(f, Kb(b))
            : 44)
        )
    ...
    function ec(a, b, c) {
      ...
      O = [
        ...
        ((N = Math.floor(d.atime.getTime() / 1e3)),
        1 <= +Math.abs(N)
          ? 0 < N
            ? (Math.min(+Math.floor(N / 4294967296), 4294967295) | 0) >>> 0
            : ~~+Math.ceil((N - +(~~N >>> 0)) / 4294967296) >>> 0
      ...
      O = [
        ...
        ((N = Math.floor(d.mtime.getTime() / 1e3)),
        1 <= +Math.abs(N)
          ? 0 < N
            ? (Math.min(+Math.floor(N / 4294967296), 4294967295) | 0) >>> 0
            : ~~+Math.ceil((N - +(~~N >>> 0)) / 4294967296) >>> 0
      ...
      O = [
        ...
        ((N = Math.floor(d.ctime.getTime() / 1e3)),
        1 <= +Math.abs(N)
          ? 0 < N
            ? (Math.min(+Math.floor(N / 4294967296), 4294967295) | 0) >>> 0
            : ~~+Math.ceil((N - +(~~N >>> 0)) / 4294967296) >>> 0
    ...
    function ua(a, b) {
      ...
      try {
        ...
        if ("function" == typeof WebAssembly.Function) {
          ...
          for (
            var h = { parameters: [], results: "v" == b[0] ? [] : [f[b[0]]] }, k = 1;
            k < b.length;
            ++k
          )
      ...
      p: function (a, b, c) {
        try {
          return (
            (b = C(b)),
            (b = dc(a, b)),
            0 === c ? ta(b) : 512 === c ? Tb(b) : E("Invalid flags passed to unlinkat"),
            0
          );
        } catch (d) {
          if ("undefined" == typeof W || !(d instanceof P)) throw d;
    ...
    (function () {
      function a(f) {
        ...
        0 == Wa &&
          (null !== Xa && (clearInterval(Xa), (Xa = null)), Ya && ((f = Ya), (Ya = null), f()));
      }
      function b(f) {
        a(f.instance);
      }
      ...
      (function () {
        return Ia ||
          ...
          ? c(b)
          : fetch(M, { credentials: "same-origin" }).then(function (f) {
    ...
    function Zc() {
      function a() {
        if (!Xc && ((Xc = !0), (e.calledRun = !0), !Ka)) {
          e.noFSInit ||
            ...
            (e.stdout = e.stdout),
            (e.stderr = e.stderr),
            e.stdin ? cc("stdin", e.stdin) : Sb("/dev/tty", "/dev/stdin"),
            e.stdout ? cc("stdout", null, e.stdout) : Sb("/dev/tty", "/dev/stdout"),
            e.stderr ? cc("stderr", null, e.stderr) : Sb("/dev/tty1", "/dev/stderr"),
            ja("/dev/stdin", 0),
            ja("/dev/stdout", 1),
            ja("/dev/stderr", 1));
          Db = !1;
      ...
      if (!(0 < Wa)) {
        if (e.preRun)
          for ("function" == typeof e.preRun && (e.preRun = [e.preRun]); e.preRun.length;) Va();
        cb(Sa);
        0 < Wa ||
          (e.setStatus
            ? (e.setStatus("Running..."),
