  ...
  return (
    <div className="space-y-5">
      ...
      <form action={createLead} className="card p-6 space-y-5 max-w-3xl">
        <div>
          <label className="label" htmlFor="title">Titre du prospect *</label>
          <input id="title" name="title" required className="input" placeholder="Ex. : Croisière Alaska famille de 4 — été 2027" />
        </div>
        <div className="grid sm:grid-cols-3 gap-4">
          <div>
            <label className="label" htmlFor="destination">Destination</label>
            <input id="destination" name="destination" className="input" placeholder="Caraïbes, Alaska…" />
          </div>
          <div>
            <label className="label" htmlFor="travelPeriod">Période souhaitée</label>
            <input id="travelPeriod" name="travelPeriod" className="input" placeholder="Décembre 2026" />
          </div>
          <div>
            <label className="label" htmlFor="budget">Budget (CAD)</label>
            <input id="budget" name="budget" type="number" min="0" step="100" className="input" />
          </div>
        </div>
        <div>
          <label className="label" htmlFor="clientId">Client existant</label>
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          ...
          <div>
            <label className="label" htmlFor="contactEmail">Courriel</label>
            <input id="contactEmail" name="contactEmail" type="email" className="input" />
          </div>
          <div>
            <label className="label" htmlFor="contactPhone">Téléphone</label>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <input id="source" name="source" className="input" placeholder="Site web, référence, salon…" />
          </div>
        </div>
        <div>
