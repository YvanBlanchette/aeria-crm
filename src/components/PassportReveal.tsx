			...
			{open && (
				<div className="fixed inset-0 z-50 flex items-center justify-center p-4">
					...
					<div className="relative w-full max-w-md rounded-xl border border-slate-200 bg-white shadow-xl p-5">
						...
						<p className="mt-2 text-sm text-slate-600">Saisissez votre mot de passe pour afficher cette donnée sensible.</p>

						<form className="mt-4 space-y-3" onSubmit={onSubmit}>
							<div>
								<label className="label" htmlFor={`passport-password-${clientId}`}>Mot de passe</label>
								<input
